...
# Aufruf:   docker build --tag juergenzimmermann/kunde:2025.10.1-eclipse-noble .
#               ggf. --progress=plain
#               ggf. --no-cache
