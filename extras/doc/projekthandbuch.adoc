...
."rentcarController" für Lesezugriffe an der REST-Schnittstelle
[plantuml,rentcarController,svg]
----
include::./rentcarController.plantuml[]
----
...
."rentcarWriteController" für Schreibzugriffe an der REST-Schnittstelle
[plantuml,rentcarWriteController,svg]
----
include::./rentcarWriteController.plantuml[]
----
...
.Die Service-Klasse "rentcarService" für die Geschäftslogik
[plantuml,rentcarService,svg]
----
include::./rentcarService.plantuml[]
----

bla bla

.Die Service-Klasse "rentcarWriteService" für die Geschäftslogik
[plantuml,rentcarWriteService,svg]
----
include::./rentcarWriteService.plantuml[]
----
...
.Die Entity-Klasse "rentcar" für rentcarndaten
[plantuml,rentcar,svg]
----
include::./rentcar.plantuml[]
----
